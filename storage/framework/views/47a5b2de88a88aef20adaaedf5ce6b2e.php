...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — Saudi License Server</title>
    ...
    <div class="sls-main">
        <div class="sls-topbar">
            ...
            <div class="d-flex align-items-center gap-3">
                <span class="text-muted small"><i class="bi bi-shield-lock"></i> <?php echo e(auth()->user()?->name ?? 'Guest'); ?></span>
...
<?php /**PATH C:\laragon\www\license-server\resources\views/layouts/admin.blade.php ENDPATH**/ ?>