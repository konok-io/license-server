...
<div class="metric-grid mb-4" id="metricGrid">
    ...
    <div class="metric">
        <div class="val <?php echo e(($m['a'] ?? false) ? 'accent' : ''); ?>" data-metric="<?php echo e($m['k']); ?>"><?php echo e($stats[$m['k']] ?? 0); ?></div>
        <div class="lbl"><?php echo e($m['l']); ?></div>
    </div>
...
$(function () {
    ...
    function loadCharts(days) {
        $.get('<?php echo e(route('admin.analytics.charts')); ?>', { days }, function (res) {
    ...
    // ---- Refresh metrics ----
    function loadStats() {
        $.get('<?php echo e(route('admin.analytics.stats')); ?>', function (s) {
    ...
    function loadWidgets() {
        $.get('<?php echo e(route('admin.analytics.widgets')); ?>', function (res) {
    ...
    function loadReport() {
        const url = currentReport === 'activations'
            ? '<?php echo e(route('admin.analytics.reports.activations')); ?>'
            : '<?php echo e(route('admin.analytics.reports.verifications')); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\license-server\resources\views/admin/analytics/index.blade.php ENDPATH**/ ?>